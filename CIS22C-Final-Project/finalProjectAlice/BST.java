...
public class BST<T> {
	private class Node { //class of node 
		private T data;
		private Node left;
		private Node right;

		public Node(T data) { //construct of node 
			this.data = data;
			left = null;
			right = null;
		}
	...
	public T getRoot() throws NoSuchElementException {
		if (isEmpty())
			throw new NoSuchElementException("getRoot:  list is empty. ");
		return root.data;
	}
	...
	private int getHeight(Node node) {
		...
		int leftLength = getHeight(node.left);
		int rightLength = getHeight(node.right);
	...
	public T findMin() throws NoSuchElementException {
		if (isEmpty())
			throw new NoSuchElementException("findMin: List is empty. ");
		else
			return findMin(root);
	}
	...
	public T findMax() throws NoSuchElementException {
		if (isEmpty())
			throw new NoSuchElementException("findMax:  list is empty. ");
		else
			return findMax(root);
	}
